...
exports.updatePassWord = catchAsync(async (req, res, next) => {
    ...
    // 2) Check if Posted current password is correct
      if(!(await user.correctPassword(req.body.passwordCurrent, user.password))) {
        return next(new AppError('Your cuurrent password is wrong.', 401))
      }
    ...
    await user.save();
    // (we dont use findByIDAndUpdate. cuz because of passwordConfirm(probably validate?) model Its gonna break.
    // Its not yet updated and defined.)
